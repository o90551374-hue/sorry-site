  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        >
          <h1 className="text-3xl text-pink-300 mb-8 leading-relaxed">Mi triste carta para ti…</h1>
          ...
          >
            <p className="text-purple-200 text-lg mb-8 leading-relaxed">
              He estado pensando horas, tratando de encontrar las palabras adecuadas...
            </p>

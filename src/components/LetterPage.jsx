  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8">
      ...
      >
        ...
        >
         tenia un monton de cosas que decirte toda la noche pero esto lo resume mejor …🌙
        </motion.h2>
        ...
        >
          ...
          >
            Eres tan hermosa, pero aun asi te lastime... lo siento mucho💔
          </motion.p>
          ...
          >
            se que lo que te hice no tiene remedio,pero necesito que sepas que significas todo para mi.He estado pensando en los momentos que salimos y me doy cuenta que lastime a una persona especial para mi solo por no saber expresarme ,prometo hacerlo mejor,ser mejor para ti.✨
          </motion.p>
          <motion.p
